...
get_geno_matrix <- function(genofile, range, variant_id, covfile = NULL, indiv = NULL) {
  # Arguments -----
  # genofile - path to tabix-indexed vcf file, e.g., `genotypes.biallelic.vcf.gz`
  # range - chrXX:start-end
  # variant_id - list of variants
  # cov - path to covariates matrix used in QTL mapping to get the list of individuals to subset genotype matrix (if needed)
  # indiv - list of individuals to filteer the genotype matrix (if needed)
  # ----------------
